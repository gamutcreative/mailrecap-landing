export default function DownloadCTA() {
  return (
    <section className="py-24 px-4 sm:px-6 bg-[#1C3A5C]">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-sm font-semibold tracking-widest uppercase text-[#E07B54] mb-4">
          Ready when you are
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="flex items-center gap-3 bg-[#E07B54] text-white px-6 py-3.5 rounded-xl font-semibold hover:bg-[#C5623A] transition-colors w-full sm:w-auto justify-center shadow-lg shadow-[#E07B54]/25"
          >
