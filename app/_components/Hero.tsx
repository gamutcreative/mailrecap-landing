  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="absolute inset-0 bg-gradient-to-br from-[#111827]/85 via-[#111827]/75 to-[#111827]/60" aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-24 w-full">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight mb-6">
            Your mail, finally{" "}
            <span className="text-[#D42232]">under control.</span>
          </h1>
          ...
          <div id="download" className="flex flex-col sm:flex-row items-start gap-4 flex-wrap">
            <a
              ...
              className="flex items-center gap-3 bg-[#D42232] text-white px-6 py-3.5 rounded-xl font-semibold hover:bg-[#b01c29] transition-colors w-full sm:w-auto justify-center shadow-lg shadow-[#D42232]/30"
            >
