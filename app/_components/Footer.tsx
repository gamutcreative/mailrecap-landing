export default function Footer() {
  return (
    <footer className="bg-[#1C3A5C] text-white/50 py-12 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-10">
          <div>
            ...
            <p className="text-sm font-medium text-[#E07B54]">Mail made simple.</p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/creators-lab" className="hover:text-[#E07B54] transition-colors">Creators Lab</a></li>
              </ul>
            </div>
            <div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" aria-label="TikTok" className="hover:text-white transition-colors">TikTok</a>
          </div>
        </div>
      </div>
    </footer>
